...
module Fluent
  module Plugin
    class TimestreamOutput < Fluent::Plugin::Output
      ...
      config_section :aws_credentials, param_name: "aws_credentials", required: false, multi: false do
      ...
      config_section :measure, param_name: "target_measure", required: false, multi: false do
